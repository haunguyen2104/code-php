...
<table class="table">
  ...
  ?>
    <tr>
      ...
      <td><a href="<?php echo BASE_URL?>admincategory/categoryDelete/<?php echo $c['catId']?>" onclick='return confirm ("Bạn có chắc chắn muốn xóa nhóm nhóm sản phẩm này vĩnh viễn không?")'>Xóa</a>|<a href="<?php echo BASE_URL?>admincategory/categoryToggleTrash/<?php echo $c['catId']?>">Sửa</a></td>
    </tr>
    <?php } ?>
  </tbody>
</table>
