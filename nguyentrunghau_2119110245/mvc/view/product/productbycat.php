  ...
  <?php foreach($products as $product){?>
    <div class="col-md-4 col-sm-6 text-center card">
      ...
      <div class="alert alert-success">
        ...
        <span class="text-decoration-line-through"><?php echo number_format($product['price'],2)?> $</span> <span> - </span> <span class="fw-bold fs-6 text-danger"><?php echo number_format($product['salePrice'],2)?> $</span>
         <?php }
          else {?>
