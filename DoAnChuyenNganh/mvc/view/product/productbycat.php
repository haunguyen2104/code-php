...
<div id="brandname" class="row alert alert-warning text-center fw-bold">
    <div class="col-md-12 fs-2"><span style="color:#ffff00;">Sản phẩm:</span> <?php echo $cat['catName']?>
    </div>
</div>
<div class="row" style="border:1px solid #ffc107; background-color:#ffc107;">
