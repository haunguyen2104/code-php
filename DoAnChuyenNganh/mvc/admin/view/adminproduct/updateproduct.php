    ...
    <form class="form-control form-control-lg p-3 mb-2 bg-secondary text-white" method="POST" action=""
        ...
        <table class="table text-white ">
            <tr>
                ...
                <td><input id="inputtext" type="text" name=inputProductName required value="<?php echo $oldproduct['productName'] ?>">
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <textarea required name="inputDetail" id="inputDetail" cols="80"
                        rows="10"><?php echo $oldproduct['detail'] ?></textarea>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="number" name="inputSalePrice" step="0.01" max=3000 min=1
                        value="<?php echo $oldproduct['salePrice'] ?>"></td>
            </tr>
            <tr>
                <td></td>
                <td id="btninput">
