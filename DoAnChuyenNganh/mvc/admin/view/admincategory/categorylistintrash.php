...
<table class="table text-white">
  ...
  foreach ($cats as $cat) {?>
    <tr>
      ...
      <td><a class="text-warning" href="<?php echo BASE_URL ?>admincategory/categoryDelete/<?php echo $cat['catId'] ?>" onclick="return confirm('Bạn có chắc chắn xóa vĩnh viễn sản phẩm này không?');">Xóa vĩnh viễn|</a><a class="text-light" href="<?php echo BASE_URL.'admincategory/categoryToggleTrash/'.$cat['catId'] ?>">|Khôi phục</a></td>
    </tr>
  <?php }?>
  </tbody>
</table>
