...
<table class="table text-white ">
  ...
  foreach ($products as $p) {?>
    <tr>
      ...
      <td><a class="text-danger" href="<?php echo BASE_URL ?>adminproduct/productToggleTrash/<?php echo $p['productId'] ?>" onclick="return confirm('Bạn có chắc chắn xóa sản phẩm này không?');">Xóa|</a><a class="text-warning" href="<?php echo BASE_URL.'adminproduct/updateproduct/'.$p['productId'] ?>">|Sửa</a></td>
    </tr>
  <?php }?>
  </tbody>
</table>
