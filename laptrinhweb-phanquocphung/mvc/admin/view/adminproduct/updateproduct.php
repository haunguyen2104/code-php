...
<div class="row border border-primary form-control form-control-lg p-3 mb-2 bg-secondary text-white">
    ...
    <form class="form-control form-control-lg p-3 mb-2 bg-secondary text-white" method="POST" action="" enctype="multipart/form-data">
        <table class="table text-white ">
            <tr >
                <td><label for="inputProductName">Tên sản phẩm</label></td>
            ...
            <tr>
                <td><label for="inputCatId">Tên nhóm sản phẩm</label></td>
            ...
            <tr>
                ...
                <td>
                    <select name="inputStatus" id="inputStatus" required>
                        ...
                        <option value="1" selected <?php if ($oldproduct['status'] == 0) echo "selected" ?>>Hiện</option>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input class="btn btn-primary" type="reset" name="reset" value="Reset"></td>
                </td>
            </tr>
        </table>
    </form>
