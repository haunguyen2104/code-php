...
<div id="brandname" class="row alert alert-warning text-center fw-bold bg-black">
    <div class="col-md-12 fs-2 f-color-warning"><span style="color:#ffff00;">Sản phẩm:</span> <?php echo $cat['catName']?>
    </div>
</div>
<div class="row borderofcard">
    <?php foreach($products as $product){?>
    <div class="col-md-3 " style="margin-bottom:8px; margin-top: 7px;">
        <div class="card">
            ...
            <div class="card-body text-center alert alert-secondary">
                ...
                <a class="card-title" style="text-decoration: none;   color:#000;   font-weight: bold;"
                ...
                <p class="card-text"><span class="fw-bold" style=" color:#000;   font-weight: bold;">Giá: </span>
                    ...
                    <span style="color:#000"
                        class="text-decoration-line-through">$<?php echo number_format($product['price'],2)?>
                    </span><span> -
